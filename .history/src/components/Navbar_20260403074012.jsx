...
import {
  ...
  ChevronDown, User, History, Heart, Menu, X, MessageCircle
} from 'lucide-react';
...
const NAV_STYLE = `
  ...
  .nv-mascot-wrapper:hover .nv-mascot-tooltip {
    opacity: 1;
  ...
  .nv-mascot-btn {
    ...
    border-bottom: 4px solid #3a8c00;
    display: flex;
    align-items: center;
...
const Navbar = () => {
  ...
  return (
    <div className="nv-root">
      ...
      {/* 🔥 LINH THÚ AI GÓC DƯỚI PHẢI 🔥 */}
      {!isActive('/ai-chat') && (
        <div className="nv-mascot-wrapper">
          <div className="nv-mascot-tooltip">
            <Sparkles size={14} style={{ display: 'inline', marginRight: 4, color: '#f59e0b' }} />
            Hỏi EngBot ngay!
          </div>
          <Link to="/ai-chat" className="nv-mascot-btn">
            🦜
            <span className="nv-mascot-badge">1</span>
          </Link>
        </div>
      )}
