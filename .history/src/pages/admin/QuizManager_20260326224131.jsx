    ...
    <div className="qm">
      ...
      <div className="qm-bar qm-up" style={{ animationDelay: ".05s" }}>
        ...
        >
          ...
          {(filterCat === "all"
            ? vocabList
            : vocabList.filter(v => String(v.CategoryID) === filterCat)
          ).map(v => (
            <option key={v.WordID} value={String(v.WordID)}>
              {v.Word}
            </option>
          ))}
        </select>
        ...
        >
          <div className="qm-modal">
            ...
            <div className="qm-modal-head">
              <h3>
                {editingId ? "✏️ Chỉnh sửa câu hỏi" : "❓ Tạo câu hỏi mới"}
              </h3>
              <button className="qm-modal-x" onClick={() => setShowForm(false)}>
                ✕
              </button>
            </div>
            ...
            <div className="qm-modal-body">
              ...
              <div className="qm-fg2">
                ...
                <div className="qm-fg">
                  ...
                  <select
                    ...
                    value={form.WordID}
                    onChange={e =>
                      setForm({ ...form, WordID: parseInt(e.target.value) })
                    }
                  >
              ...
              {selectedVocab && (
                <div className="qm-vocab-info">
                  <span>📖</span>
                  <span>
                    <b>{selectedVocab.Word}</b> — {selectedVocab.Meaning}
                  </span>
                  <span
                    className="qm-badge cat"
                    style={{ marginLeft: "auto" }}
                  >
                    {selectedVocab.CategoryName}
                  </span>
                </div>
              )}
                 {/* Lesson */}
