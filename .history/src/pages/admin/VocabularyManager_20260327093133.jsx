...
const STYLES = `
  ...
  .vm-modal-head h3 { font-size:15px; font-weight:600; display:flex; align-items:center; gap:7px; }
  .vm-modal-close {
    background:none; border:1px solid var(--border); border-radius:6px;
    width:28px; height:28px; color:var(--muted); font-size:14px;
  ...
  .vm-form-group { display:flex; flex-direction:column; gap:5px; }
  .vm-form-group.full { grid-column:1/-1; }
  .vm-form-label { font-size:11px; text-transform:uppercase; letter-spacing:.9px; color:var(--muted); }
  .vm-form-input {
    background:var(--surface); border:1px solid var(--border); border-radius:6px;
    padding:8px 12px; color:var(--text); font-family:'DM Sans',sans-serif;
    font-size:13px; outline:none; transition:border-color .18s; width:100%;
  }
  ...
  .vm-img-placeholder { width:100%; height:80px; border-radius:6px; border:1px dashed var(--border); display:flex; align-items:center; justify-content:center; color:var(--muted); font-size:12px; margin-top:5px; background:var(--surface); }
  .vm-file-label { display:inline-flex; align-items:center; gap:5px; padding:6px 12px; border-radius:6px; border:1px solid var(--border); background:var(--surface); color:var(--muted); font-size:12px; cursor:pointer; transition:all .13s; margin-top:4px; }
  ...
  .vm-confirm h4 { font-size:15px; font-weight:600; margin-bottom:5px; }
  .vm-confirm p  { font-size:13px; color:var(--muted); margin-bottom:14px; line-height:1.5; }
