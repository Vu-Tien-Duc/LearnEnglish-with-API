...
const STYLES = `
  ...
  .vm-badge.lesson { background:rgba(244,114,182,.08); color:var(--accent3); font-size:12px; }
  ...
  .vm-file-label {
    ...
    transition:all .15px; margin-top:6px;
  }
...
const EMPTY_FORM = {
  Word:"", Meaning:"", CategoryID:1, LessonID:null, DifficultyLevel:1,
...
function SkelRow() {
  ...
  return (
    <tr>
      {[140,100,80,80,60,90,150,50,160,120,60,80].map((w,i)=>(
...
export default function VocabularyManager() {
  ...
  useEffect(() => { fetchCategories(); fetchLessons(); fetchData(); }, []);
