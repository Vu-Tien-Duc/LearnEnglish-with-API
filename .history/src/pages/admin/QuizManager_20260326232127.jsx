...
const STYLES = `
  ...
  .qm-q-text { font-size:16px; font-weight:500; max-width:260px; overflow:hidden; text-overflow:ellipsis; display:-webkit-box; -webkit-line-clamp:2; -webkit-box-orient:vertical; }
