...
const STYLES = `
  ...
  .qm-badge { display:inline-flex; align-items:center; padding:2px 8px; border-radius:20px; font-size:14px; font-weight:500; }
  ...
  .qm-q-text { font-size:15px; font-weight:500; max-width:260px; overflow:hidden; text-overflow:ellipsis; display:-webkit-box; -webkit-line-clamp:2; -webkit-box-orient:vertical; }
