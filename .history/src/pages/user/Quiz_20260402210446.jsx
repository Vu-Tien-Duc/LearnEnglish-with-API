...
const Quiz = () => {
  ...
  const handleSelectOption = async (option) => {
    ...
    if (option.isCorrect) {
      // 1. CHỌN ĐÚNG
      // Tính điểm: Lấy 100 trừ đi (số lần sai * 25). Tối thiểu là 25 điểm.
      ...
      try {
        await API.post('/user/quiz/submit', {
          ...
          score: scoreForThisQ, // Gửi điểm xuống backend (Backend sẽ update/ghi đè)
        });
      ...
      <div style={styles.container}>
        ...
        {loading ? (
          ...
          <div style={styles.finishCard}>
            ...
            {/* Đã sửa hiển thị điểm trung bình */}
