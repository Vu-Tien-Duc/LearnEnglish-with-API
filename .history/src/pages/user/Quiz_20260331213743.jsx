...
import { Volume2, CheckCircle2, XCircle, Award, ArrowRight, BookOpen, ChevronRight, ArrowLeft, Sparkles } from 'lucide-react';
...
const Quiz = () => {
  ...
  // Các state phục vụ tính điểm lùi dần
  ...
  // 2. BẮT ĐẦU QUIZ (Nếu lesson = null thì là Ôn tập tổng hợp)
  ...
  const handleSelectOption = async (option) => {
    ...
    if (option.isCorrect) {
      // 🎯 CÔNG THỨC: Điểm = max(100 - (Lần sai * 25), 25)
        ...
        <div style={styles.container}>
          ...
          {loading ? (
            ...
            <div style={styles.lessonGrid}>
              ...
              {/* 🔥 THẺ ĐẶC BIỆT: ÔN TẬP TỔNG HỢP (Lấy các câu không có LessonID + trộn tất cả) */}
  ...
  return (
    <div style={styles.root}>
      ...
      <div style={styles.container}>
        ...
        {loading ? (
          <div style={styles.loadingText}>Đang xáo trộn 10 câu hỏi ngẫu nhiên...</div>
        ) : questions.length === 0 ? (
...
const styles = {
  ...
  quizTopBar: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: '100%', marginBottom: '32px', borderBottom: '2