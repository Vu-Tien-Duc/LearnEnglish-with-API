...
// Bọc hàm fetchLessons bằng useCallback
const fetchLessons = useCallback(async () => {
  // logic gọi API của bạn ở đây...
}, []); // Nếu bên trong hàm này có dùng state nào thì thêm vào mảng này

useEffect(() => {
  injectCSS();
  if (!user) { navigate('/login'); return; }
  fetchLessons();
}, [navigate, user, fetchLessons]); // Lúc này thêm fetchLessons vào là an toàn tuyệt đối
