...
export const MemoryGame = () => {
  ...
  if (loading) return <div style={{textAlign: 'center', marginTop: '80px', fontSize: '20px', fontWeight: 'bold', color: '#16a34a'}}>Đang chia bài...</div>;
...
export const WordScrambleGame = () => {
  ...
  if (loading) return <div style={{textAlign: 'center', marginTop: '80px', fontSize: '20px', fontWeight: 'bold', color: '#2563eb'}}>Đang chuẩn bị...</div>;
...
const styles = {
  // Bố cục chung
  page: { padding: '32px', minHeight: '100vh', backgroundColor: '#f8fafc', fontFamily: "'Inter', sans-serif" },
