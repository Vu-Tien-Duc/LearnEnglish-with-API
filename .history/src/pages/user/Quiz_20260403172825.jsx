...
const [loading, setLoading] = useState(true);
  ...
  }, [userId]); // Chỉ phụ thuộc vào userId thay vì cả object user

  // 3. useEffect nằm SAU và gọi hàm một cách an toàn
  useEffect(() => {
    injectCSS();
    ...
    fetchLessons();
  }, [navigate, userId, fetchLessons]); // Mảng dependency giờ đã an toàn tuyệt đối
