...
useEffect(() => {
    ...
    // Đảm bảo lấy đúng ID (Đề phòng trường hợp API Login trả về field viết thường/hoa khác nhau)
  ...
  }, []); // Note: nếu React cảnh báo thiếu dependencies, bạn có thể thêm user vào ngoặc []

  if (!user) return <GuestLanding navigate={navigate} />;

  const pct = stats?.completionPercentage || 0;
  const menus = [
    { icon: Icons.book,  title: "Học từ vựng",  desc: "Lật thẻ · New / Learning / Mastered", accent: "#10b981", bg: "#f0fdf4", path: "/flashcard" },
