...
// 1. Khai báo fetchLessons TRƯỚC và bọc bằng useCallback
const fetchLessons = useCallback(async () => {
  // Thêm chốt chặn an toàn: nếu chưa có user thì không gọi API
  if (!user) return; 
...
}, [user]); // Phải có 'user' ở đây vì bên trong hàm có dùng user.UserID

// 2. useEffect gọi ở SAU
useEffect(() => {
  injectCSS();
  ...
  fetchLessons();
}, [navigate, user, fetchLessons]); // Đưa fetchLessons vào mảng an toàn
