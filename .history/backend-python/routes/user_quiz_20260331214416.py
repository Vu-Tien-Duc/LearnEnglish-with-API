...
# GET /api/user/lessons
# Trả về danh sách lessons CÓ CÂU HỎI TRẮC NGHIỆM kèm điểm TB
@user_quiz_bp.route("/lessons", methods=["GET", "OPTIONS"])
@cross_origin()
def get_lessons():
    ...
    # 🔥 ĐÃ SỬA: JOIN trực tiếp với QuizQuestions để chỉ lấy những bài CÓ CÂU HỎI
    cursor.execute("""
        SELECT 
            l.LessonID, 
            l.LessonName, 
    ...
    # 🔥 ĐÃ SỬA: Trả về key "TotalQuestions" để khớp 100% với giao diện React
    return jsonify([{
        "LessonID": r[0],
        "LessonName": r[1],
        "CategoryName": r[2],
