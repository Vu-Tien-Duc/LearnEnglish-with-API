...
from routes.admin_favoritewords import admin_favoriteword_bp
...
app.register_blueprint(admin_lesson_bp, url_prefix="/api/admin/lesson")
app.register_blueprint(admin_favoriteword_bp, url_prefix="/api/admin/favoriteword")
@app.route("/")
def home():
